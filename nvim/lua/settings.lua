...
vim.keymap.set('n', '<C-`>', function() vim.cmd('ToggleTerm direction=float') end, { desc = "Toggle floating terminal" })
vim.keymap.set('t', '<C-`>', '<Cmd>ToggleTerm direction=float<CR>', { desc = "Hide floating terminal" })
